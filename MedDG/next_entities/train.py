...
projectName = 'MedDG_模型简化2_增加转移概率'
...
epochs = 100
batch_size = 16
steps_per_epoch = 155211 // batch_size  # 实际训练集数量(最大) 155211
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if metrics > self.best_bleu:
            ...
            model.save_weights(os.path.join(self.model_saved_path, 'MedDG_next_MedBert_f1_%.5f.weights'%metrics))
...
if __name__ == '__main__':
    ...
    #model.load_weights(os.path.join(resultPath, "best_weights"))
