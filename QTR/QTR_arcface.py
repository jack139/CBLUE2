    ...
    def __iter__(self, random=False):
        ...
        for is_end, (text1, text2, label) in self.sample(random):
            ...
            if len(batch_token_ids) == self.batch_size or is_end:
                ...
                batch_labels_categorical = keras.utils.to_categorical(batch_labels, num_classes)
                yield [batch_token_ids, batch_segment_ids, batch_labels_categorical], batch_labels_categorical
                batch_token_ids, batch_segment_ids, batch_labels = [], [], []
...
output = ArcFace(num_classes, regularizer=regularizers.l2(1e-4))([output, y])
model = keras.models.Model(bert.model.input+[y], output)
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_acc > self.best_val_acc:
            ...
            model.save_weights('qtr_gp_best_arcface_acc_%.5f.weights'%val_acc)
        print(
