...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_acc > self.best_val_acc:
            ...
            model.save_weights('qtr_gp_best_model_acc_%.5f.weights'%val_acc)
        print(
...
if __name__ == '__main__':
    ...
    #model.load_weights('qtr_gp_best_model_acc_0.68658.weights')
    ...
    model.load_weights('./qtr_gp_best_model_acc_0.69104.weights')
