...
if __name__ == '__main__':
    ...
    parser.add_argument("--decode_filename", default="data/medi_finished_dir/test.bin", type=str,
                        help="需要生成摘要的文件") 
    parser.add_argument("--output_filenames", default="data/medi_finished_dir/file_names_test", type=str,
                        help="输出的文件名存在该文件中")
