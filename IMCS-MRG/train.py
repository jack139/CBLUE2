...
train_data_path = os.path.join(current_dir, "data/medi_finished_dir/chunked/train_*")
eval_data_path = os.path.join(current_dir, "data/medi_finished_dir/dev.bin")
decode_data_path = os.path.join(current_dir, "data/medi_finished_dir/test.bin")
vocab_path = os.path.join(current_dir, "data/medi_finished_dir/vocab")
...
class Train(object):
    ...
    def save_model(self, running_avg_loss, iter):
        ...
        model_save_path = os.path.join(self.model_dir, 'model_%d_%.4f_%d.weights' % (iter, running_avg_loss, int(time.time())))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_gpu", action="store_true",default=False,
                        help="是否使用gpu，默认为否")  
    parser.add_argument("--log_root", default=os.path.join(current_dir, "data/log/"), type=str,
                        help="log的位置")  
