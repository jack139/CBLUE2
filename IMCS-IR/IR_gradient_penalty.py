...
# 加载数据集
train_data = load_data('../dataset/IMCS-IR/new_split/IMCS_train.json')
valid_data = load_data('../dataset/IMCS-IR/new_split/IMCS_dev.json')
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if val_f1 > self.best_val_f1:
            ...
            model.save_weights('ir_gp_best_f1_%.5f.weights'%val_f1)
        print(
...
if __name__ == '__main__':
    ...
    model.load_weights('ir_gp_best_f1_0.76304.weights')
    predict_to_file('../dataset/IMCS-IR/IMCS_test.json', './IMCS-IR_test.json')
