...
predicate = sorted(['临床表现', '基本情况', '治疗方案', '治疗药物', '禁用药物', '用法用量'])
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('triples_best_model_f1_%.5f.weights'%f1)
...
if __name__ == '__main__':
    ...
    #model.load_weights('triples_best_model_f1_0.79871.weights')
    ...
    model.load_weights('triples_best_model_f1_0.81600.weights')
    predict_to_file('../data/Text2DT/Text2DT_test.json', '../data/Text2DT/Text2DT_triples_test.json')
