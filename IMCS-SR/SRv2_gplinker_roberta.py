...
def extract_spoes(text, threshold=0, return_s_idx=False):
    """抽取输入text所包含的三元组
    """
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('sr-v2_gp_roberta_f1_%.5f.weights'%f1)
...
if __name__ == '__main__':
    ...
    #model.load_weights('sr-v2_gp_roberta_f1_0.67388.weights')
