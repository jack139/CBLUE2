...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            train_model.save_weights(f'sr_roberta_best_f1_{f1:.5f}.weights')
...
if __name__ == '__main__':
    ...
    #train_model.load_weights('sr_roberta_best_f1_0.70500.weights')
    ...
    train_model.load_weights('sr_roberta_best_f1_0.69321.weights')
    predict_to_file('../dataset/IMCS-SR/IMCS_test.json', 'IMCS-SR_test.json')
