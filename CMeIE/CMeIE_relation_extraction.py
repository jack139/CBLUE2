...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            train_model.save_weights('cmeie_best_model_f1_%.5f.weights'%f1)
...
if __name__ == '__main__':
    ...
    train_model.load_weights('cmeie_best_model.weights')
    predict_to_file('../dataset/CMeIE/CMeIE_test.json', 'data/CMeIE_test.json')
