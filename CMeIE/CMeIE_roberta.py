...
# 加载数据集
train_data = load_data('../dataset/CMeIE/CMeIE_train.json')
valid_data = load_data('../dataset/CMeIE/CMeIE_dev.json')
predicate2id, id2predicate = {}, {}

with open('../dataset/CMeIE/53_schemas.json') as f:
    for l in f:
        l = json.loads(l)
...
optimizer = AdamEMA(learning_rate=2e-6)
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            train_model.save_weights('cmeie_best_roberta_f1_%.5f.weights'%f1)
...
if __name__ == '__main__':
    ...
    #train_model.load_weights('cmeie_best_roberta_f1_0.60639.weights')
    ...
    train_model.load_weights('cmeie_best_roberta_f1_0.59450.weights')
    predict_to_file('../dataset/CMeIE/CMeIE_test.json', 'CMeIE_test.json')
