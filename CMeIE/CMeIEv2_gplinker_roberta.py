...
# 加载数据集
train_data = load_data('../dataset/3.0/CMeIE-V2/CMeIE-V2_train.jsonl')
valid_data = load_data('../dataset/3.0/CMeIE-V2/CMeIE-V2_dev.jsonl')
predicate2id, id2predicate = {}, {}

with open('../dataset/3.0/CMeIE-V2/53_schemas.jsonl') as f:
    for l in f:
        l = json.loads(l)
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('cmeie-v2_gp_roberta_f1_%.5f.weights'%f1)
...
if __name__ == '__main__':
    ...
    model.load_weights('cmeie-v2_gp_roberta_f1_0.54612.weights')
    ...
    model.load_weights('cmeie-v2_gp_roberta_f1_0.54940.weights')
    predict_to_file('../dataset/3.0/CMeIE-V2/CMeIE-V2_test.jsonl', 'CMeIE-V2_test.jsonl')
